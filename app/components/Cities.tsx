    ...
    <div className="w-full bg-gray-300">
      <div>
        <div className="group relative">
          <div className=" w-full h-[200px] justify-center text-black-800 pt-[80px] text-center ">
      ...
      <div className=" flex w-full justify-center pb-[80px] gap-2">
        <div className="w-[400px]">
          <div className="group relative h-[260px]">
            ...
            />
            <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-gradient-to-r from-gray-900 to-transparent opacity-0 group-hover:h-full group-hover:opacity-100 duration-500">
