  ...
  return (
    <div className='flex w-full'>
        <div className="w-[25%] ">
            ...
            <Link className="mt-5 px-8 py-3 rounded-[10px] bg-white hover:bg-white-600 duration-300" href="https://portal.piaic.org/signup">Continue</Link>
        </div>
        </div>
        </div>
        ...
        <div className="w-[25%]">
            <div className="group relative h-[450px]">
            <div className=" w-full h-[450px] text-white text-center py-[100px] bg-gradient-to-tr from-gray-800 to-gray-700 h-[450px]">
